...
zerops:
  ...
  - setup: prod
    build:
      ...
      buildCommands:
        # npm install (not ci) — Nuxt 4's transitive deps have
        # a known peer-dep conflict that npm ci rejects. With a
        # committed lock file, npm install is still reproducible.
        - npm install
